...
\* BEGIN TRANSLATION (chksum(pcal) = "b16dd023" /\ chksum(tla) = "4d295fbc")
\* Label UpdatedPos of process Master at line 49 col 17 changed to UpdatedPos_
\* Label UpdatedPos of process Worker1 at line 96 col 15 changed to UpdatedPos_W
...
UpdatedVel == /\ pc["master"] = "UpdatedVel"
              /\ IF updatedVelocity = 3
                    ...
                    ELSE /\ allVelocitiesUpdated
                         /\ pc' = [pc EXCEPT !["master"] = "ResetReadyBarrier"]
                         /\ UNCHANGED allVelocitiesUpdated
              /\ UNCHANGED << iter, maxIter, processReady, allReady, 
                              updatedVelocity, updatedPosition, 
                              allPositionsUpdated, nWorkers, body, bodies >>

ResetReadyBarrier == /\ pc["master"] = "ResetReadyBarrier"
                     /\ allReady' = FALSE
                     /\ processReady' = 0
                     /\ pc' = [pc EXCEPT !["master"] = "IncUpdatedPosition"]
...
Master == MainLoopMaster \/ IncReadyToStart \/ ReadyToStart
             ...
             \/ ResetReadyBarrier \/ IncUpdatedPosition \/ UpdatedPos_
...
Worker1 == MainLoopW1 \/ IncReadyToStartW1 \/ ReadyToStartW1 \/ UpdVelB1
              ...
              \/ UpdPosB2 \/ IncUpdatedPosW1 \/ UpdatedPos_W
...
Worker2 == MainLoopW2 \/ IncReadyToStartW2 \/ ReadyToStartW2 \/ UpdVelB3
              ...
              \/ UpdPosB4 \/ IncUpdatedPosW2 \/ UpdatedPos
...
\* Last modified Wed Mar 30 10:01:12 CEST 2022 by davidedomini

...
\* BEGIN TRANSLATION (chksum(pcal) = "e520ce53" /\ chksum(tla) = "b5b813c3")
...
MainLoopW1 == /\ pc["worker1"] = "MainLoopW1"
              /\ IF iter < maxIter
                    THEN /\ IF iter + 1 = 10
                               ...
                               ELSE /\ pc' = [pc EXCEPT !["worker1"] = "IncReadyToStartW1"]
...
MainLoopW2 == /\ pc["worker2"] = "MainLoopW2"
              /\ IF iter < maxIter
                    THEN /\ IF iter + 1 = 10
                               ...
                               ELSE /\ pc' = [pc EXCEPT !["worker2"] = "IncReadyToStartW2"]
...
\* Last modified Wed Mar 30 16:27:48 CEST 2022 by davidedomini

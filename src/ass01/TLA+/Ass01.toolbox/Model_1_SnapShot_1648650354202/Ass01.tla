...
\* BEGIN TRANSLATION (chksum(pcal) = "b238f259" /\ chksum(tla) = "d309e4a5")
...
NewIter == /\ pc["master"] = "NewIter"
           /\ iter' = iter + 1
           /\ pc' = [pc EXCEPT !["master"] = "SaveThatIsLastIter"]
...
Master == MainLoopMaster \/ IncReadyToStart \/ ReadyToStart
             ...
             \/ ResetVelBarrier \/ NewIter \/ SaveThatIsLastIter
...
\* Last modified Wed Mar 30 16:25:46 CEST 2022 by davidedomini
